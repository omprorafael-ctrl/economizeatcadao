...
const ManagerDashboard: React.FC<ManagerDashboardProps> = ({ 
  ...
  const menuItems = [
    ...
    { id: 'sellers', label: 'Time de Vendas', icon: Contact },
    { id: 'orders', label: 'Gestão Pedidos', icon: ShoppingCart },
    { id: 'admins', label: 'Configurações', icon: ShieldCheck },
  ];

  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden text-slate-800">
      {/* Sidebar - Light Clean Style */}
      <aside className="w-72 bg-white border-r border-slate-200 flex flex-col hidden lg:flex shadow-sm">
        <div className="p-8">
